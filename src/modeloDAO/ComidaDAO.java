...
public class ComidaDAO {
    ...
    public static Boolean addAll(java.util.ArrayList<Object> articulos, Connection connection) throws SQLException {
        for (Object obj : articulos) {
            if (obj instanceof modelo.Bebida) {
                ComidaDAO.guardar((Comida) obj, BEBIDA, connection);
            } else {
                ComidaDAO.guardar((Comida) obj, PLATILLO, connection);
            }
        }
        return true;
    }
